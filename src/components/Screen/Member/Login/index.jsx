  ...
  return (
    <>
      <Screen className="screen_join__email">
        <section>
          <Title>{isCertificateMode ? "은행 인증서로 로그인" : "이메일로 로그인"}</Title>
          <Subtitle>
            {isCertificateMode
              ? "인증서를 선택 후 개인정보와 추가정보를 입력해주세요."
              : "정보를 입력해주세요."}
          </Subtitle>
          <Inner>
            <IconLock />
            {isCertificateMode ? (
              <form className="form_email_join" onSubmit={handleCertificateSubmit}>
                ...
                <BaseButtonContainer>
                  <BaseButton type="submit" size="md" style="solid__primary" disabled={isBusy}>
                    금융인증서로 로그인
                  </BaseButton>
                </BaseButtonContainer>
              </form>
              ...
              <form className="form_email_join" onSubmit={handleSubmit}>
                ...
                <BaseButtonContainer>
                  <BaseButton type="submit" size="md" style="solid__primary" disabled={isLoading}>
                    로그인
                  </BaseButton>
                </BaseButtonContainer>
              </form>
            ...
            {/* <BaseButtonContainer>
                            {isCertificateMode ? (
                                ...
                                <BaseButton
                                    ...
                                    size="md"
                                    style="outline__black"
                                    onClick={onClickSwitchToCertificate}
                                    disabled={isBusy}
                                >
                                    금융인증서 로그인으로 진행하기
                                </BaseButton>
